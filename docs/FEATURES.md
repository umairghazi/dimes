...
| Supabase database migration | 🚧 | New branch direction: Supabase/Postgres replaces MongoDB; initial SQL schema, RLS policies, backend admin client, and env examples added |
