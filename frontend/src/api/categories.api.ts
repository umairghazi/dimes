...
export const categoriesApi = {
  ...
  create: (data: { name: string; group?: string; type?: "expense" | "income"; isFixed?: boolean }) =>
    apiClient.post<UserCategory>("/categories", data).then((r) => r.data),

  update: (id: string, data: { name?: string; group?: string | null; type?: "expense" | "income" | null; isFixed?: boolean }) =>
